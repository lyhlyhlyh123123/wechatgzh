...
const opts = {
  ...
  眼镜: ['不戴', '黑框眼镜', '金丝眼镜', '墨镜', '圆框眼镜'],
}

const presets = [
  { label: '居家慵懒', values: { 发型:'长发自然散落', 脸型:'鹅蛋脸', 年龄:'25~30岁', 身材:'微胖有肉感', 穿搭:'紧身吊带', 场景:'卧室床上', 看哪里:'直视镜头', 眼镜:'不戴' }},
  { label: '逛街随拍', values: { 发型:'披肩发', 脸型:'瓜子脸', 年龄:'25~35岁', 身材:'匀称健康', 穿搭:'紧身牛仔裤', 场景:'街边', 看哪里:'直视镜头', 眼镜:'不戴' }},
  { label: '办公室', values: { 发型:'马尾', 脸型:'鹅蛋脸', 年龄:'30~35岁', 身材:'丰满圆润', 穿搭:'衬衫', 场景:'办公室', 看哪里:'直视镜头', 眼镜:'金丝眼镜' }},
  { label: '咖啡时光', values: { 发型:'卷发慵懒', 脸型:'瓜子脸', 年龄:'25~30岁', 身材:'苗条纤细', 穿搭:'修身连衣裙', 场景:'咖啡厅', 看哪里:'看窗外', 眼镜:'不戴' }},
  { label: '旗袍韵味', values: { 发型:'盘发', 脸型:'鹅蛋脸', 年龄:'30~35岁', 身材:'丰满圆润', 穿搭:'旗袍', 场景:'咖啡厅', 看哪里:'直视镜头', 眼镜:'不戴' }},
]
